        ...
        <div className="background-image">
          <div className="banner-Image">
            <h2 className="text-center text-white ">
              <div className="">
               <h4 className="">Are you finding properties to Buy or Rent???</h4>
              </div>
            </h2>
              ...
              <div className="">
                ...
                <div className="css-slide-element css-slide-element1 ml-5">
                  <div className="css-card-body ml-5 border border-success">
                    <a href="/edge/interior-furniture">
                      <div className="css-card-body-inside ml-3 mt-1">
                        <img
                          src={furniture}
                          className="img-css"
                ...
                <div className="css-slide-element css-slide-element1 ml-5">
                  <div className="css-card-body ml-5 mr-3 border border-info">
                    <a href="/edge/property-management">
                      <div className="css-card-body-inside ml-3 mt-1">
                        <img src={property} className="img-css" alt="img"></img>
                      </div>
                      <div>
                        <div className="css-text ml-3 text-info">
                          Property Management
                        </div>
                      </div>
                    </a>
      ...
      {/* <div id="featuredDevelopers" className="topProject-div">
        <section>
          <header className="header">
            ...
            <div className="sub-title">Prominant Developers in Ahmedabad </div>
          </header>
        </section>
      </div>
      ...
      <div id="featuredProjects" className="topProject-div">
        <section>
          <header className="header">
            ...
            <div className="sub-title">Exclusive showcase of top projects</div>
          </header>
        </section>
      </div>
